...
1.  Con el `data.frame` creado en el ejercicio 2.2.1, cuenta el número de casos que hay en cada isla y calcula la media de la longitud del ala en cada isla.
