...
📝 La función `return()` se usa para indicar explicitamente qué se quiere obtener en una función. Se recomienda su uso cuando el retorno no se espera al final de la función. P.e. en las ramas de una estructura *if/else*, sobre todo si hay alguna rama larga y compleja.

#### Ejercicio 2

¿Cómo generalizarías la función exp_plot para que te sirviera para cualquier base de datos y cualquier variable categórica?
