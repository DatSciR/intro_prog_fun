...
### ejercicio julen
aquí se podría añadir unas líneas de código con un estilo feo y que ellos lo corrijan. Quizás la ref de style guide que está en bibliografía se podría traer aquí? luego se hablar más de los nombres de funcionaes y demás pero eso ya lo podrían aplicar en el siguiente ejercicio
...
### ejercicio julen
aquí se los podría proponer utilizar un operador funcional de alguna forma que resulte util
...
### ejercicio julen
aquí se los podría proponer que paralelicen algun ejemplo que han hecho anteriormente
