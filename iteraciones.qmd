...
<!-- DIBUJO VERO: menos prioritario. se podria dibujar lo que indico a continuacion tambien? es el dibujo que viene justo despues de este ejemplo aqui: map_dbl(x, mean, na.rm = TRUE)
